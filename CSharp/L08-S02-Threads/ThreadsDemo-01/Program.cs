...
namespace ThreadsDemo.ConsoleMessages
{
    class Program
    {
        static void Main()
        {
            ...
            //Console.WriteLine("Количество рабочих потоков     : {0}..{1}", minWorkerThreads, maxWorkerThreads);
            //Console.WriteLine("Количество потоков ввода/вывода: {0}..{1}", minCompletionPortThreads, maxCompletionPortThreads);
