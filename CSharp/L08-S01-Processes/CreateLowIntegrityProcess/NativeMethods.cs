...
namespace BelhardTraining.LessonMultithreading
{
	...
	internal static class NativeMethods
	{
		...
		/// </param>
		/// <returns></returns>
		[DllImport("advapi32", CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, SetLastError = true, PreserveSig = true)]
		...
		//[DllImport("kernel32", CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, PreserveSig = true)]
