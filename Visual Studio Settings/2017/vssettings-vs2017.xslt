...
<!-- Debugging -> General
	...
	Enables  "Use the new Exception Helper"
...
<xsl:template match="Category[@RegisteredName='Debugger'][@PackageName='Visual Studio Debugger']/PropertyValue[@name='UseNewExceptionHelper']" ><PropertyValue name="UseNewExceptionHelper">1</PropertyValue></xsl:template>
...
-->
<xsl:template match="ToolsOptions/ToolsOptionsCategory[@RegisteredName='Environment']/ToolsOptionsSubCategory[@RegisteredName='ProjectsAndSolution']/PropertyValue[@name='OnRunWhenOutOfDate']"><PropertyValue name="OnRunWhenOutOfDate">4</PropertyValue></xsl:template>
